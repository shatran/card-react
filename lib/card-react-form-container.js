  ...
  CardReactFormContainer = React.createClass({
    ...
    getDefaultProps: function() {
      return {
        ...
        initialValues: {},
        fieldTypes: ["number", "cvc", "expiry", "name", 'submit']
      };
    },
          ...
          if (child.props && child.props.name) {
            ...
            if (newClassName && inputsValidationClass) {
              ...
              if(child.props.name === "Submit" &&
                  _this.inputIsValid(_this.state.inputsValidationClass['CCname']) &&
                  _this.inputIsValid(_this.state.inputsValidationClass['CCnumber']) &&
                  _this.inputIsValid(_this.state.inputsValidationClass['CCexpiry']) &&
                  _this.inputIsValid(_this.state.inputsValidationClass['CCcvc'])
            ...
            return React.cloneElement(child, {
              ...
              disabled: child.props.name === "Submit" ? disableButton : false
    ...
    validateInput: function(inputName, inputValue) {
      ...
      currentInputsValidationClass[inputsNames["submit"]]   = "card-submit";
    ...
    inputIsValid: function (inputClass) {
      if(inputClass && inputClass === this.props.classes.valid ){ return true }
    },
    render: function() {
